  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
      <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs text-white/40 mb-6">
        ...
        <span>/</span>
        <span className="text-white/70">Service Warranty Policy</span>
      </nav>
      <h1 className="font-heading text-3xl sm:text-4xl text-white mb-4">Service Warranty Policy</h1>
  ...
  return (
    <main className="relative pb-20 md:pb-0">
      ...
      <section className="min-h-screen bg-[#041827] pt-24 sm:pt-28 pb-16">
        <PolicyLayout>
          <h2 className="font-heading text-xl text-white mt-8 mb-3">1. Service Warranty Coverage</h2>
          <p>{BUSINESS_NAME} provides a service warranty on labour for repairs and service visits. The warranty period and terms are as follows:</p>
          <ul className="list-disc pl-5 space-y-1">
            <li><strong>Labour Warranty:</strong> 30 days from the date of service for most repair work.</li>
            <li><strong>Installation Warranty:</strong> 30 days from the date of installation for workmanship.</li>
            <li><strong>AMC Plans:</strong> Coverage as specified in the plan document for the contract duration.</li>
          </ul>
          <p>The warranty covers the same issue resurfacing due to faults in workmanship. It does not cover new issues or unrelated problems.</p>

          <h2 className="font-heading text-xl text-white mt-8 mb-3">2. What is Not Covered</h2>
          <ul className="list-disc pl-5 space-y-1">
            <li>Damage caused by misuse, mishandling, or unauthorized modification</li>
            <li>Issues caused by external factors (power surges, water quality changes, etc.)</li>
            <li>Normal wear and tear, including consumable items like filters and membranes</li>
            <li>Issues arising from pre-existing conditions not identified during service</li>
            <li>Service visits required due to customer negligence or incorrect usage</li>
          </ul>

          <h2 className="font-heading text-xl text-white mt-8 mb-3">3. Spare Parts Warranty</h2>
          <p>Spare parts replaced during service carry their own warranty as per the manufacturer&apos;s terms. We will pass through any applicable manufacturer warranty on parts supplied by us.</p>

          <h2 className="font-heading text-xl text-white mt-8 mb-3">4. Claiming Warranty</h2>
          <p>To claim warranty service:</p>
          <ul className="list-disc pl-5 space-y-1">
            <li>Contact us within the warranty period with your service details</li>
            <li>Provide the original service receipt or booking details</li>
            <li>Describe the issue you are experiencing</li>
            <li>Allow us to verify the issue and schedule a visit if needed</li>
          </ul>

          <h2 className="font-heading text-xl text-white mt-8 mb-3">5. Warranty Limitations</h2>
          <ul className="list-disc pl-5 space-y-1">
            <li>Warranty is non-transferable and applies only to the original customer and equipment</li>
            <li>Warranty coverage is limited to the specific issue addressed during the service visit</li>
            <li>We reserve the right to assess and determine warranty eligibility</li>
            <li>Travel charges may apply for warranty visits outside our primary service area</li>
          </ul>
